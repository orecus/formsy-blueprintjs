...
var FormsyDateTimePicker = function (_Component) {
  ...
  _createClass(FormsyDateTimePicker, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_datetime.DateTimePicker, { defaultValue: this.props.defaultValue, value: this.props.getValue(), onChange: this.changeValue, disabled: configuration.disabled, className: configuration.className });
    }
  }]);
