        ...
        output = _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('input', { disabled: configuration.disabled, id: this.props.name, className: configuration.inputClassNames, type: configuration.type, placeholder: configuration.placeholder, name: this.props.name, value: this.props.getValue(), onChange: this.changeValue, onKeyDown: this.onKeyDown, onFocus: this.onFocus, onBlur: this.onBlur }),
