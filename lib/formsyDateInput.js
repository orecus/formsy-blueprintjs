  ...
  _createClass(FormsyDateInput, [{
    ...
    value: function render() {
      ...
      var configuration = {
        ...
        minDate: (0, _moment2.default)().format(),
        maxDate: (0, _moment2.default)().add(50, 'years').format()
      };
      ...
      if (this.props.maxDate) {
        configuration.maxDate = (0, _moment2.default)(this.props.maxDate).format();
      }
      if (this.props.minDate) {
        configuration.minDate = (0, _moment2.default)(this.props.minDate).format();
      }
