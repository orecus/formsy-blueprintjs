  ...
  _createClass(FormsyDateInput, [{
    ...
    value: function render() {
      ...
      var configuration = {
        ...
        maxDate: (0, _moment2.default)().add(50, 'years').toDate()
      };
      ...
      if (this.props.maxDate) {
        configuration.maxDate = (0, _moment2.default)(this.props.maxDate).toDate();
      }
      if (this.props.minDate) {
        configuration.minDate = (0, _moment2.default)(this.props.minDate).toDate();
      }
