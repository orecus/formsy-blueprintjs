...
var FormsyCheckbox = function (_Component) {
  ...
  _createClass(FormsyCheckbox, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_core.Checkbox, { defaultChecked: this.props.getValue(), checked: this.props.getValue(), label: this.props.label, onChange: this.changeValue, disabled: configuration.disabled, className: configuration.className });
    }
  }]);
...
FormsyCheckbox.propTypes = (_FormsyCheckbox$propT = {
  label: _react2.default.PropTypes.string.isRequired,
  name: _react2.default.PropTypes.string.isRequired,
  inline: _react2.default.PropTypes.bool,
  defaultChecked: _react2.default.PropTypes.bool
}, _defineProperty(_FormsyCheckbox$propT, 'name', _react2.default.PropTypes.string), _defineProperty(_FormsyCheckbox$propT, 'fill', _react2.default.PropTypes.bool), _defineProperty(_FormsyCheckbox$propT, 'disabled', _react2.default.PropTypes.bool), _FormsyCheckbox$propT);

exports.default = (0, _formsyReact.HOC)(FormsyCheckbox);