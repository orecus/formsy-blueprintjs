  ...
  _createClass(FormsyRadioGroup, [{
    ...
    value: function render() {
      ...
      var radioButtons = this.props.children.map(function (option, i) {
        return _react2.default.createElement(_core.Radio, { key: option.value, value: option.value, label: option.label, className: configuration.radioItem, style: configuration.radioStyle });
      });
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _core.RadioGroup,
                { selectedValue: this.props.getValue(), className: configuration.inputClassNames, disabled: configuration.disabled, onChange: this.props.onChange || this.changeValue, style: this.props.inputStyle, onFocus: this.onFocus, onBlur: this.onBlur },
                radioButtons
              )
            ),
